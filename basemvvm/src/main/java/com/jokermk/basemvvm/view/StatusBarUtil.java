...
//        window.setStatusBarColor(Color.TRANSPARENT);
    ...
    public static void setColorDark(Activity activity, @ColorInt int color, @IntRange(from = 0, to = 255) int statusBarAlpha) {
        if (isFlyme4Later()) {
